...
namespace ProjAtividadelUnitTest.Api.Controllers
{
    ...
    public class AtividadeController : ControllerBase
    {
        ...
        public async Task<ActionResult<Atividade>> PutAtividade(int id, Atividade atividade)
        {
            ...
            return await _context.Atividade.FindAsync(id); ;
        }
        ...
        {
            return _context.Atividade.OrderByDescending(p => p.Id).FirstOrDefault().Id;
        }
    }
}
